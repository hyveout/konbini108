...
function SplashScreen({ onEnter }) {
  return (
    <div className="screen splash-bg scanlines noise" style={{
      ...
      <div className="splash-lanterns" style={{
        ...
        {[0,1,2,3,4].map(i => (
          <div key={i} style={{
            ...
            borderRadius: '50%',
            boxShadow: '0 0 15px rgba(255,200,100,0.6), 0 -8px 0 -6px #2a2a2a',
            opacity: 0.85,
      ...
      {/* Top: title + poster */}
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', marginTop: 34, position: 'relative', zIndex: 10, flex: 1, justifyContent: 'center' }}>
        <div style={{
        ...
        <div className="splash-subtitle" style={{
          ...
          fontSize: 13, color: '#fff', marginTop: 4, fontWeight: 700,
          letterSpacing: '0.25em',
        }}>
          コンビニ・イチマルハチ
        </div>

        {/* Cover poster — smaller on mobile */}
        <div className="splash-poster-frame" style={{
          marginTop: 18, width: 'min(190px, 55vw)', padding: 5,
      ...
      {/* Bottom: tagline + CTA */}
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', zIndex: 20 }}>
        ...
        <div className="splash-cta-line" style={{ marginTop: 6, color: 'var(--yellow)', fontFamily: 'VT323, monospace', fontSize: 13 }}>
  ...
  return (
    <div style={{
      ...
      <div className={'photo-frame ' + bgCls} style={{
        ...
        <div style={{
          fontSize: 34, position: 'relative', zIndex: 2,
      ...
      <div style={{
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        padding: '0 8px', borderLeft: '2.5px solid var(--ink)',
        background: inCart ? 'var(--pink)' : 'var(--ink)',
      }}>
        {inCart ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
            <button onClick={onAdd} style={{
              width: 26, height: 22, background: '#fff', color: 'var(--ink)',
              fontFamily: 'Bebas Neue', fontSize: 14, lineHeight: 1,
              border: '1.5px solid var(--ink)',
            }}>+</button>
            <span style={{
              fontFamily: 'Bebas Neue', fontSize: 15, color: '#fff',
          ...
          <button className="press" onClick={onAdd} style={{
            ...
            fontFamily: 'Bebas Neue', fontSize: 14, padding: '10px 14px',
            letterSpacing: '0.1em', border: '2px solid var(--ink)',
