...
function App() {
  ...
  // (screen state is intentionally NOT persisted — see above)
  ...
  const onShare = (platform, shareData) => {
    if (window.KonbiniShare && typeof window.KonbiniShare.shareReceipt === 'function') {
      window.KonbiniShare.shareReceipt(platform, shareData);
    } else {
      console.warn('[share] KonbiniShare not loaded');
    }
  };
